...
export async function signInWithGoogle() {
  ...
  try {
    ...
    if (error.code === "auth/unauthorized-domain") {
      return {
        ok: false,
        reason: `Add ${location.hostname} to Firebase Authentication > Settings > Authorized domains.`
      };
    }
    ...
    if (error.code === "auth/popup-blocked") {
      return {
        ok: false,
        reason: "The browser blocked the Google popup. Allow popups for this app, then try again."
      };
    }
